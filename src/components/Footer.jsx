export const Footer = () => {
  return (
    <>
        <div className="flex mt-16 text-left border-b p-4 border-slate-700">
            <div className="font-Raleway font-thin text-slate-300 ml-8">
            ...
            <div>
                <button className="rounded-full bg-slate-800 ml-8 mr-4 p-2">
                ...
                <button className="rounded-full bg-slate-800 mx-4 p-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-facebook"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>            </button>
            </div>
        </div>
        <div className="flex mt-4 ml-12 text-left font-thin text-slate-300">
        Legal &nbsp;
